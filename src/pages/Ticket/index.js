    ...
    <>
      ...
      <div className="bg-primary px-5 py-5">
        <div className="bg-grey px-5 py-5 mx-5 my-5 border-rounded2">
          ...
          {data && (
            <div className="tiket-wrapper px-5 py-5">
              <div className="row header">
                <div className="col-8">
                  <div className="container py-3 side-left">
                    ...
                    <h4 style={{ fontWeight: 600 }}>Admit One</h4>
                  </div>
                </div>
              ...
              <div className="row content">
                <div className="col-8">
                  <div className="container py-5">
                    <div className="item-wrap">
                      ...
                      <h3 className="desc">{data.movie}</h3>
                    </div>
                    <div className="row mt-4">
                      <div className="col-4">
                        <div className="item-wrap">
                          <p className="title">Date</p>
                          <h3 className="desc">{data.date}</h3>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="item-wrap">
                          <p className="title">Time</p>
                          <h3 className="desc">{data.time}</h3>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="item-wrap">
                          <p className="title">Category</p>
                          <h3 className="desc">{data.category}</h3>
                        </div>
                      </div>
                    </div>
                    <div className="row mt-4">
                      <div className="col-4">
                        <div className="item-wrap">
                          ...
                          <h3 className="desc">{data.count} pieces</h3>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="item-wrap">
                          <p className="title">Seats</p>
                          <h3 className="desc">{data.seats}</h3>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="item-wrap">
                          <p className="title">Price</p>
                          <h3 className="desc">${data.price}.00</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-4 right">
                  ...
                  <img
                    ...
                    src="./assets/images/barcode2.png"
                    alt="barcode"
                    width="230"
                    height="50"
                  />
          ...
          <div className="d-flex justify-content-center">
            ...
            <div className="btn-transparent ms-2">
              <div className="d-flex mx-4 mt-2">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
